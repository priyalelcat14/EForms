sap.ui.define(["sap/ui/core/mvc/Controller",
  ...
  var mode;
   var text2;
  return BaseController.extend("spefar.app.controller.Dialog13", {
    ...
    _onButtonPress: function() {
      ...
      sap.ui.controller("spefar.app.controller.FarRequest").navigate_inbox();
    ...
    onInit: function() {
      this._oDialog = this.getView().getContent()[0];
        ...
        var url = "/sap/opu/odata/sap/YFPSFIPFRDD0026_POLITICAL_FRM_SRV/";
