		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Pricat Catalogue",
									"targetURL": "#valiozpricat-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"valiozpricat-display": {
								"semanticObject": "valiozpricat",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=valio.zpricat",
									"url": sap.ui.require.toUrl("valio/zpricat")
								}
							}
						}
					}
